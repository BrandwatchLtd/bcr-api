...
class BWQueries(BWResource, bwdata.BWData):
    ...
    def upload(self, create_only=False, modify_only=False, **kwargs):
        ...
        Args:
            ...
            languages: Optional, defaults to en. Pass in no arguments to make the query language agnostic
    ...
    def _fill_data(self, data):
        ...
        # currently languages field defaults to 'en', similar to UI, but it could alternatively default to an empty list, to create a language agnostic query
        ...
        # languageAgnostic is a deprecated variable. If a user does not pass in any language arguments, the languages attribute will create an empty list.
